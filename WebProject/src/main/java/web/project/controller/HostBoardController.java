...
public class HostBoardController implements ApplicationContextAware {
	...
	public String insertBoard(Model model, Board board, Long frontImgNo, @ModelAttribute("host") Host host,
			List<MultipartFile> frontImg, List<MultipartFile> image) {
//		호스트 아이디 가져오기
...
//		저장
	...
	public String viewBoard(Model model, @RequestParam(name = "p", defaultValue = "1") int pNum,

...
<nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="nav-item">
      <a class="nav-link" href="#scrollspyHeading2">유의사항</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="#scrollspyHeading3">REVIEW</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="#scrollspyHeading4">지 도</a>
    </li>
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Dropdown</a>
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="#scrollspyHeading3">REVIEW</a></li>
        <li><a class="dropdown-item" href="#scrollspyHeading4">예약 하기</a></li>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="#scrollspyHeading5">지 도</a></li>
      </ul>
    </li>
  </ul>
</nav>
<div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example" tabindex="0">
  <h4 id="scrollspyHeading1">공간정보</h4>
   <h2>공간 정보</h2><br>
   ${board.content }
  <h4 id="scrollspyHeading2">유의사항</h4>
   <hr><br><h1>유의사항</h1>
  ...
  <h3>${board.caution }</h3><hr>
  <h4 id="scrollspyHeading4">REVIEW</h4>
  <!-- Review  -->
		<div>
			<div class="board">
				<div class="board_tit">
			 ...
			 <hr>
  <h4 id="scrollspyHeading5">예약 하기</h4>
  <!-- booking -->
	<div>
  ...
  <h4 id="scrollspyHeading6">지 도</h4>
  <div id="map"></div>
			<h1>${board.address }</h1>
			<h2>${board.zipcode }</h2>
	<hr>

...
<body style="background-color: #f6f6f6;">
  ...
  <ul class="nav nav-pills">
    <li class="nav-item">
      <a style="color: #656565; text-decoration: none; font-weight: bold;" class="nav-link" href="#scrollspyHeading1">공간 소개</a>
    </li>
    <li class="nav-item">
      <a style="color: #656565; text-decoration: none; font-weight: bold;" class="nav-link" href="#scrollspyHeading2">이용 안내</a>
    </li>
    <li class="nav-item">
      <a style="color: #656565; text-decoration: none; font-weight: bold;" class="nav-link" href="#scrollspyHeading3">주의 사항</a>
    </li>
    <li class="nav-item">
      <a style="color: #656565; text-decoration: none; font-weight: bold;" class="nav-link" href="#qna">Q&A</a>
    </li>
    <li class="nav-item">
      <a style="color: #656565; text-decoration: none; font-weight: bold;" class="nav-link" href="#review">리뷰</a>
    </li>
    <li class="nav-item">
      <a style="color: #656565; text-decoration: none; font-weight: bold;" class="nav-link" href="#reservation">예약하기</a>
    </li>
    <li class="nav-item">
      <a style="color: #656565; text-decoration: none; font-weight: bold;" class="nav-link" href="#location">위치</a>
    </li>
  </ul>
</nav>
<!-- 네비정보 -->

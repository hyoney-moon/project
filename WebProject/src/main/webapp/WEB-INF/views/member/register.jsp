...
<section class="content">
	<!-- 회원가입 -->
	<form action="/join" id="registerform" enctype="multipart/form-data"
	method="post">
	<!-- onsubmit="return check()" -->
		...
		<table border="1" width="50%" height="80%" align='center'>
			...
			<tr>
				...
				<td>&nbsp;&nbsp;&nbsp; <input type="" name="custId"
					id="custId" size="30" maxlength=50"
					required="required" />
			...
			<tr>
         		...
         		size="20" required="required" value="0" checked="checked"/>
         		남자

	...
	<!-- 기본 메뉴 -->
		...
		<section class="sidebar">
			<ul class="nav nav-tabs">
				...
				<li role="presentation"><a href="${pageContext.request.contextPath}/member/login">로그인</a></li>
				<li role="presentation"><a href="${pageContext.request.contextPath}/member/register">회원가입</a></li>
			</ul>
		</section>
	</aside>
	<div>
